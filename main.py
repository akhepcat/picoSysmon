...
if __name__  == "__main__":
    ...
    sysmon = picoSysmon(CONFIG.DEBUG, CONFIG.SSID, CONFIG.PSK, CONFIG.COUNTRY, CONFIG.INFLUXURL, CONFIG.TOKEN, CONFIG.HOSTNAME, CONFIG.BME680_SDA, CONFIG.BME680_SCL, CONFIG.LOGFILE )
    sysmon.run()
    exit(0)
